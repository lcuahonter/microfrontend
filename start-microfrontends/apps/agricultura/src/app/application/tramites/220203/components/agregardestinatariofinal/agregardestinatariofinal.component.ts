...
export class AgregardestinatariofinalComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
     this.destinatarioForm = this.fb.group({
      ...
      nombre: ['', [Validators.maxLength(200), Validators.required]],
      primerApellido: ['', [Validators.maxLength(200), Validators.required]],
  ...
  /**
   * llamado para obtener el catalogo de paises.
   * */
  obtenerPaises():void{
    this.tercerosrelacionadosService.obtieneCatalogoConsultaPaises(220203).subscribe({
      next: (data: BaseResponse<Catalogo[]>) => {
