...
export class RemisionMuestrasDiagnosticoComponent implements OnInit, OnDestroy {
  ...
  formRemisionMuestrasDiagnostico: FormGroup = this.fb.group({
    tipoLaboratorio: ['', [Validators.required]],
    nombreLaboratorio: ['', [Validators.required]],
    analisisSolicitado: ['', [Validators.required]],
    tamanoMuestra: ['', [Validators.required]],
    unidadMedida: ['', [Validators.required]],
    fechaTomaMuestra: ['', [Validators.required]],
      ...
      this.formRemisionMuestrasDiagnostico.patchValue(
        {
          ...
          nombreLaboratorio: next.remision_muestra.descripcion_laboratorio,
          analisisSolicitado:
  ...
  isInvalid(controlName: string): boolean {
    const CONTROL: AbstractControl =
      this.formRemisionMuestrasDiagnostico.get(controlName)!;
