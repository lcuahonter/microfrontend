...
export class AgregarMercanciaComponent implements OnChanges, OnInit, OnDestroy {
  ...
  crearFormulario(): void {
    this.agregarMercanciaForm = this.fb.group({
      fraccionArancelaria: [
        {
          value: this.solicitud220501State.fraccionArancelaria,
          disabled: true,
        },
      ],
      descripcionFraccion: [
        {
          value: this.solicitud220501State.descripcionFraccion,
          disabled: true,
        },
      ],
      nico: [{ value: this.solicitud220501State.nico, disabled: true }],
      descripcion: [
        { value: this.solicitud220501State.descripcion, disabled: true },
      ],
      unidaddeMedidaDeUMT: [
        {
          value: this.solicitud220501State.unidaddeMedidaDeUMT,
          disabled: true,
        },
      ],
      cantidadTotalUMT: [
        { value: this.solicitud220501State.cantidadTotalUMT, disabled: true },
      ],
      saldoPendiente: [
        { value: this.solicitud220501State.saldoPendiente, disabled: true },
      ],
      saldoACapturar: [
        this.solicitud220501State.saldoACapturar,
