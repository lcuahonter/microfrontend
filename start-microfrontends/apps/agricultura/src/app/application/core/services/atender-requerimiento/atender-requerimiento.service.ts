import {
  API_GET_INICIAR_ATENDER_REQUERIMIENTO,
  API_POST_ACUSE_REQUERIMIENTO,
  API_POST_FIRMAR,
  API_POST_MOSTRAR_FIRMAR,
  IDSOLICITUD,
  NUMFOLIOTRAMITE,
  TRAMITE
} from '../../../../application/constantes/atender-requerimiento/api-constants';
// } from '../../../constantes/atender-requerimiento/api-constants';
