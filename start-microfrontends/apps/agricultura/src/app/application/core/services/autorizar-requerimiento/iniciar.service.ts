...
import { API_POST_INICIAR_AUTORIZAR_REQUERIMIENTO, ENVIRONMENT } from '@libs/shared/data-access-user/src';
...
export class IniciarService {
  ...
  /** 
   * Inicia autorizacion un nuevo requerimiento en el sistema
   ...
   */
  postIniciarAutorizarRequerimiento(tramite: number, numFolio: string, PAYLOAD: IniciarRequerimientoRequest):
