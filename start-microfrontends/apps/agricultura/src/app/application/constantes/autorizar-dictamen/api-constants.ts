...
/**
 * API para obtener oficio resolucion 220202
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Autorizar%20Dictamen/guardar-oficio-resolucion-autorizacion
 */
export const API_POST_OFICIO_RESOLUCION_AUTORIZACION = `sat-t${TRAMITE}/tramite/${NUMFOLIOTRAMITE}/dictamen/oficio-resolucion-autorizacion/guardar`;

/**
 * API para obtener oficio resolucion 220202
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Autorizar%20Dictamen/guardar-oficio-resolucion-autorizacion
 */
export const API_POST_OFICIO_RESOLUCION_RECHAZADO = `sat-t${TRAMITE}/tramite/${NUMFOLIOTRAMITE}/dictamen/oficio-resolucion-rechazado/guardar`;
