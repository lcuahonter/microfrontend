import { AccionBoton, Catalogo, CategoriaMensaje, Notificacion, PASOS, Usuario } from '@ng-mf/data-access-user';
import { Component, EventEmitter, OnInit, Output } from '@angular/core';
import { DatosPasos } from '@ng-mf/data-access-user';
import { ListaPasosWizard } from '@ng-mf/data-access-user';
import { ID_PROCEDIMIENTO, TITULOMENSAJE } from '../../constants/permiso-ordinario-importacion-substancias-quimicas.enum';
...
export class SolicitudPageComponent implements OnInit {
  ...
  */
   ...
   */
  public solicitudState!: Tramite240305State;
 ...
 */
  ...
  /**
 * Modelo de la justificación del trámite.
 * Almacena el texto de justificación capturado en el formulario.
 */
 ...
 *
 * @param tramiteQuery Servicio de consulta del estado del trámite.
 * @param tramiteStore Store encargado de actualizar el estado del trámite.
 * @param datosSolicitudService Servicio para obtener y gestionar datos relacionados con la solicitud.
 */
  constructor(
    private tramiteQuery: Tramite240305Query,
    private tramiteStore: Tramite240305Store,
  ...
  * 
  * - Carga la información inicial necesaria para la vista.
  * - Se suscribe al observable del índice de pestaña seleccionada
  *   para mantener sincronizado el estado local (`subIndice`).
  */
  ngOnInit(): void {
