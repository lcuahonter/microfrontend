 ...
 */
   ...
   *
   * @param tramiteQuery - Servicio para obtener información del trámite 240105.
...
*/
  ...
  /**
  * Inicializa el componente suscribiéndose a los estados reactivos de las secciones y pestañas.
  * - `tramiteQuery.selectSeccionState$`: Actualiza `solicitudState` con el estado de la sección del trámite.
  * - `solicitanteQuery.selectSeccionState$`: Actualiza `solicitante` y determina si es persona moral (`esPersonaMoral`).
  * - `tramiteQuery.getTabSeleccionado$`: Mantiene `subIndice` con el índice de la pestaña seleccionada, usando 1 como valor por defecto.
  * 
  * Todas las suscripciones se cancelan automáticamente al destruir el componente gracias a `takeUntil(this.destroyNotifier$)`.
  */
  ngOnInit(): void {
...
*/
  ...
  /**
  * Restablece el valor del índice a 1.
  * Generalmente se utiliza para regresar a la vista o paso inicial
  * dentro del flujo del componente.
  */
  cancelar(): void {
    this.indice = 1;
  }
