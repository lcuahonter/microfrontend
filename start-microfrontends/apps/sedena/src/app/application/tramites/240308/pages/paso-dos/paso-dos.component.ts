...
export class PasoDosComponent implements OnInit, OnDestroy {
   ...
   * Se suscribe al evento de carga de archivos para emitir el evento de reenvío
   * y construye el texto de requisitos reemplazando el ID de la solicitud.
   */
  ngOnInit(): void {
  ...
  /**
* Finaliza el ciclo de vida del componente.
* Emite y completa el notifier para cancelar
* las suscripciones activas y liberar recursos.
*/
  ngOnDestroy(): void {
