import { AccionBoton, Catalogo, CategoriaMensaje, DatosPasos, ListaPasosWizard, Notificacion, PASOS, Usuario, WizardComponent } from '@libs/shared/data-access-user/src';
import { Component, EventEmitter, Output, ViewChild } from '@angular/core';
import { ID_PROCEDIMIENTO, TITULOMENSAJE } from '../../constants/agregar-destinatario.enum';
...
export class SolicitudPageComponent {
  ...
  */
   ...
   */
  public solicitudState!: Tramite240112State;
 ...
 */
  constructor(private tramiteQuery: Tramite240112Query, private datosSolicitudService: DatosSolicitudService, private tramiteStore: Tramite240112Store) { }
 ...
 */
  ...
  /**
 * Inicializa el componente suscribiéndose al índice
 * de la pestaña seleccionada para actualizar el subíndice.
 */
  ngOnInit(): void {
    this.tramiteQuery.getTabSeleccionado$.subscribe(i => {
      this.subIndice = i ?? 1;
    });
  }
