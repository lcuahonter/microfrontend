 ...
 *
 * - Escucha el evento de carga de archivos para emitir la acción correspondiente.
 * - Obtiene el identificador de la solicitud y lo inyecta en el texto dinámico.
 * - Asegura la correcta liberación de recursos al destruir el componente.
 */
  ngOnInit(): void {
