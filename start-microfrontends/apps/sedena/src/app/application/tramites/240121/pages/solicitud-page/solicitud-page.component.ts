...
import { Catalogo, CategoriaMensaje, DatosPasos, Notificacion, Usuario, WizardComponent } from '@ng-mf/data-access-user';
import { ListaPasosWizard } from '../../modelos/exportacion-explosivo.model';
import { ID_PROCEDIMIENTO, PASOS } from '../../constantes/exportacion-armas-explosivo.enum';
...
export class SolicitudPageComponent {
  ...
  */
   ...
   */
  public solicitudState!: Tramite240121State;
...
*/
  ...
  */
  ...
  /**
* @constructor
* Inyecta los servicios necesarios para acceder al estado del trámite,
* gestionar datos de la solicitud y manejar la lógica del store.
*/
