import { AVISO, AccionBoton, BtnContinuarComponent, Catalogo, CategoriaMensaje, Notificacion, NotificacionesComponent, Usuario } from '@ng-mf/data-access-user';
import { CommonModule } from '@angular/common';
import { Component, EventEmitter, OnInit, Output } from '@angular/core';
import { DatosPasos } from '@ng-mf/data-access-user';
import { ListaPasosWizard } from '@ng-mf/data-access-user';
import { ID_PROCEDIMIENTO, PASOS } from '../../constantes/exportacion-quimicas-sustancias.enum';
...
import { Tramite240117State, Tramite240117Store } from '../../estados/tramite240117Store.store';
...
export class SolicitudPageComponent implements OnInit {
  ...
  */
   ...
   */
  public solicitudState!: Tramite240117State;
 ...
 */
  ...
  */
  ...
  /**
    ...
    */
  public async validarFormulario(data: any): Promise<boolean> {
    try {
      ...
      const informacionConfidencial = data.informacionConfidencial;
      ...
      const payload = {
        ...
        informacion_confidencial: informacionConfidencial,
      };

      const res = await firstValueFrom(
        this.datosSolicitudService.validarDatos(payload, this.idProcedimiento).pipe(take(1))
      );
      ...
      if (res?.codigo === '00') {
        const DATOS_DEL_TRAMITE: DatosDelTramiteFormState = {
          ...
          aduanasSeleccionadas: data.seleccionarAduanasDisponiblesDatos,
      ...
      this.nuevaNotificacion = {
        ...
        modo: 'action',
        titulo: '',
        mensaje: res.error || 'Error al validar formulario.',
        cerrar: false,
        txtBtnAceptar: '',
        txtBtnCancelar: '',
      };
      ...
      const MENSAJE = err?.error?.error || 'Error inesperado al validar formulario.';
      this.nuevaNotificacion = {
        tipoNotificacion: 'toastr',
        categoria: CategoriaMensaje.ERROR,
        modo: 'action',
