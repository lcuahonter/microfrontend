...
import { ConsultaioQuery, ConsultaioState, SolicitanteComponent, SubsecuenteIoQuery } from '@ng-mf/data-access-user';
...
export class PasoUnoComponent implements OnInit, OnDestroy {
   ...
   * @param consultaioQuery Query de estado para el trámite 31907. 
   */
  constructor(
    private consultaioQuery: ConsultaioQuery,
    private subsecuenteQuery: SubsecuenteIoQuery,
    private service: GuardarServiceT31907) { }
