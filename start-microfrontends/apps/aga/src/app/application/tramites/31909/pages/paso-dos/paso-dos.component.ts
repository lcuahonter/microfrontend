...
import { CadenaOriginal31909Service } from '../../services/cadenaOriginal.service';
...
import { Firma31909Service } from '../../services/firma.service';
...
export class PasoDosComponent implements OnInit, OnDestroy {
  ...
  public estadoSolicitud!: EstadoSolicitud31909;
  folio!: string;
  ...
  constructor(
    ...
    private tramiteQuery: Tramite31909Query,
    private cadenaService: CadenaOriginal31909Service,
    private firmaService: Firma31909Service
  ) {
