import { AcusesResolucionesTabsComponent, AcusesYResolucionesDocumentosComponent, AcusesYResolucionesFolioDelTramiteDetallesComponent, BotonAccion, ConsultaioStore, DocumentoInterfaz, LoginQuery, SolicitudesSubsecuentesService } from '@ng-mf/data-access-user';
import { Component, OnDestroy, OnInit } from "@angular/core";
import { Subject, map, takeUntil } from "rxjs";
import { AccuseComponentes } from "@libs/shared/data-access-user/src/core/models/lista-trimites.model";
import { CommonModule } from "@angular/common";
import { LISTA_TRIMITES } from "../../core/enums/lista-trimites.enums";
import { SubsecuenteIoStore } from '@ng-mf/data-access-user';
...
export class AcusesYResolucionesFolioDelTramiteDetallesContenedorComponent
  ...
  */
  ...
  constructor(
    ...
    private subsecuenteStore: SubsecuenteIoStore,
  ...
  private obtenerDetallesDeLaSolicitud(): void {
    this.solicitudesSubsecuentesService.getDetalleDeSolicitud(this.idSolicitud, this.rfcValor, 'PersonaMoral')
      ...
      .subscribe((res) => {
        ...
        /**
         * Actualiza el estado del store de SubsecuenteIo con los datos obtenidos de la solicitud, 
         * pensado para el registro de tramites subsecuentes.
         */
        this.subsecuenteStore.setState(
