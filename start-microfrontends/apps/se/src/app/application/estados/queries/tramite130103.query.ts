...
import { Tramite130103State, Tramite130103Store } from '../tramites/tramite130103.store';

/**
 * @descripcion
 * Clase que implementa las consultas (queries) para el estado del trámite 130103.
 * Proporciona selectores para acceder a diferentes partes del estado almacenado en el store.
 *
 * @decorador @Injectable
 */
@Injectable({ providedIn: 'root' })
export class Tramite130103Query extends Query<Tramite130103State> {
  /**
   * @descripcion
  ...
  /**
   * @descripcion
   * Constructor de la clase `Tramite130103Query`.
   * Inicializa la consulta con el store proporcionado.
   * @param {Tramite130103Store} store - Instancia del store del trámite 130103.
   */
