import { AcusesResolucionesTabsComponent, AcusesYResolucionesDocumentosComponent, BotonAccion, DocumentoInterfaz, LoginQuery, SolicitudesSubsecuentesService } from "@libs/shared/data-access-user/src";
