 ...
 */
const PROCEDURE = '/sat-t90304';

/**
 * API para guardar la solicitud del tramite 90304.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t90304/swagger-ui/index.html#/Solicitud/guardar
 */
export const API_POST_SOLICITUD = 'sat-t90304/solicitud/guardar';

/**
 * Rutas de la API para el procedimiento 90304
 */
export const PROC_90304 = {
