...
/**
 * Evento que emite una notificación cuando se realiza una acción en el anexo.
 */
  @Output() anexoNotificacion = new EventEmitter<Notificacion>();
...
mostrarNotificacionExito():void
{
  ...
  catalogoFraccionSeleccionado: string | null = null;
  /**
   * Muestra el popup de "Proyecto IMMEX" si la categoría es 'IMMEX'.
   * @param categoria 
   */
  onMostrarProyectoImmex(categoria: string): void {
  this.mostrarProyectoImmexPopup = categoria === 'IMMEX';
    this.catalogoFraccionSeleccionado = categoria;
}
