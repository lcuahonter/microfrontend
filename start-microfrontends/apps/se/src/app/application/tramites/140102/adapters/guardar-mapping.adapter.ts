...
export class GuardarMappingAdapter {
   ...
   */
 static fromApiPayload(payload: CargaUtilDeRespuesta,state: Programa140102State): Programa140102State {
   ...
   * @param store Opcional: instancia del store de Programa140102State
   * @returns Partial<Programa140102State>
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  static patchToStore(response: any, store: Tramite140102Store): void {
