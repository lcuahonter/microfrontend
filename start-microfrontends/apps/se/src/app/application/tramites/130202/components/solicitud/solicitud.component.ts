import { Catalogo, ConfiguracionColumna, ConsultaioQuery, ConsultaioState, Notificacion, REGEX_NUMERO_DECIMAL_ENTERO, REG_X } from '@ng-mf/data-access-user';
 ...
 */
  ...
  getMostrartodosPaisesSeleccionadosEvent(seccionState: Record<string, unknown>): void {
    this.exportacionMineralesDeHierroService.getPaisesTodoService(this.idProcedimiento.toString()).pipe(take(1)).subscribe((data) => {
