...
describe('SeleccionDelCupoComponent', () => {
  ...
  it('should run #initializeForm()', async () => {
    ...
    // expect(component.fb.group).toHaveBeenCalled();
      ...
      it('should run #getRegimen() and call store/setRegimen', async () => {
        ...
        component.tramite120402Store = { setRegimen: setRegimenMock };
      ...
      it('should run #getTratado() and call store/setTratado', async () => {
        ...
        component.tramite120402Store = { setTratado: setTratadoMock };
      ...
      it('should run #obtenerValorProducto() and call store/setProducto', async () => {
        ...
        component.tramite120402Store = { setProducto: setProductoMock };
      ...
      it('should run #getSubproducto() and call store/setSubproducto', async () => {
        ...
        component.tramite120402Store = { setSubproducto: setSubproductoMock };
  ...
  it('should run #getRegimen()', async () => {
    ...
    component.tramite120402Store.setRegimen = jest.fn();
    component.getRegimen();
    // expect(component.seleccionForm.get).toHaveBeenCalled();
    // expect(component.tramite120402Store.setRegimen).toHaveBeenCalled();
  });
  ...
  it('should run #getTratado()', async () => {
    ...
    component.tramite120402Store = component.tramite120402Store || {};
    component.tramite120402Store.setTratado = jest.fn();
    component.getTratado();
    // expect(component.seleccionForm.get).toHaveBeenCalled();
    // expect(component.tramite120402Store.setTratado).toHaveBeenCalled();
  });
  ...
  it('should run #obtenerValorProducto()', async () => {
    ...
    component.tramite120402Store = component.tramite120402Store || {};
    component.tramite120402Store.setProducto = jest.fn();
    component.obtenerValorProducto();
    // expect(component.seleccionForm.get).toHaveBeenCalled();
    // expect(component.tramite120402Store.setProducto).toHaveBeenCalled();
  });
  ...
  it('should run #getSubproducto()', async () => {
    ...
    component.tramite120402Store = component.tramite120402Store || {};
    component.tramite120402Store.setSubproducto = jest.fn();
    component.getSubproducto();
    // expect(component.seleccionForm.get).toHaveBeenCalled();
    // expect(component.tramite120402Store.setSubproducto).toHaveBeenCalled();
  });
