 ...
 */
export const API_POST_SOLICITUD = 'sat-t120204/solicitud/guardar';

/**
 * Rutas de la API para el procedimiento 120204
 */
export const PROC_120204 = {
  GET_FORM_DATA: `${BASE_URL}${API}${API_VERSION}${PROCEDURE}${SOLICITUD}/acuse`,
  OBTENER_CERTIFICADOS: (idSolicitud: string ): string => `${BASE_URL}${API}${PROCEDURE}/solicitud/obtener-certificados/${idSolicitud}`,
  OBTENER_LICITACIONES: (rfc: string ): string => `${BASE_URL}${API}${PROCEDURE}/solicitud/obtener-licitacion/${rfc}`,
  BUSCAR_LICITACION: `${BASE_URL}${API}${PROCEDURE}/solicitud/buscar_licitacion`,
