/**
 * Conjunto de rutas de la API para el procedimiento 130203.
 */
import { ENVIRONMENT } from "@libs/shared/data-access-user/src/enviroments/enviroment";
import { PAIS } from "../../../shared/constantes/complimentos.enum";
/**
 * url base de la API
 */
 ...
 */
const PROCEDURE = '/sat-t130203';

/**
 * Rutas de la API para el procedimiento 130203
 */
export const PROC_130203 = {
    ...
    /** Ruta para enviar los datos del formulario */
    PAISES_EMISOR:`${BASE_URL}${API}${PROCEDURE}/solicitud/mostrar/pais-ingles?cvePais=`,
    ...
    CLASIFICACION_REGIMEN: (regimenId: string | number): string =>
        `${BASE_URL}${API}${PROCEDURE}/catalogo/clasificaciones-regimen/${regimenId}`,
};
