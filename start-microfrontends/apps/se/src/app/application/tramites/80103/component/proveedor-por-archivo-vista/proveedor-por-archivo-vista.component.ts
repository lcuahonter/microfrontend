...
/**
 * Componente para la vista de anexar documentos en el trámite 80103.
 * Este componente permite a los usuarios adjuntar documentos necesarios
 * para completar el proceso de solicitud.
 *
 * @remarks
 * Este componente es autónomo y utiliza el módulo `CommonModule` y el componente `CargaPorArchivoComponent`.
 */
@Component({
