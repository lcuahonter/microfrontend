...
export interface Tramite80101State {
  ...
  /** Clave dinámica para producto de exportación. */
...
export class Tramite80101Store extends Store<Tramite80101State> {
  ...
  /**
   * Establece la clave del producto de exportación en el estado de la tienda.
   * *
   * @param claveProductoExportacion - La clave del producto de exportación que se desea establecer.
   */
  setClaveProductoExportacion(claveProductoExportacion: number): void {
    this.update((state) => ({
      ...state,
      claveProductoExportacion,
    }));
  }
  /**
