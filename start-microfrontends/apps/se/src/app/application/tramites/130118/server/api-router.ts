...
/**
 * API para consulta de firma de la solicitud del tramite 130118.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t130118/swagger-ui/index.html#/Registro-Solicitud/solicitud-detalle_1
 */
export const API_GET_CONSULTA_BANDEJA_SOLICITUDES = (IDSOLICITUD: string) : string => `sat-t130118/solicitud/${IDSOLICITUD}/detalle`;
