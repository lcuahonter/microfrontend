...
export interface ProsecState {
        /**
         * @property {string|null} sectoresProsecConf
         * @description
         * Configuración de sectores PROSEC.
         */
        sectoresProsecConf?: string | null;

        /**
         * @property {string|null} seleccionar
         * @description
         * Valor de selección para el trámite.
         */
        seleccionar?: string | null;
      // Backend-required fields for guardar payload
      ...
      fraccionSeleccionada?: unknown[];
      productorIndirecto?: unknown[];
      // ...existing code...

      /**
       * @property {string|null} entidadFederativaDomicilios
       * @description
       * Clave o nombre de la entidad federativa de los domicilios.
       */
      entidadFederativaDomicilios?: string | null;
  ...
  return {
    ...
    solicitante: {
      ...
      domicilio: {
        ...
        delegacion_municipio_clave: '',
        delegacion_municipio_nombre: '',
        colonia_clave: '',
        colonia_nombre: '',
        localidad_clave: '',
        localidad_nombre: '',
...
export class AutorizacionProsecStore extends Store<ProsecState> {
    /**
     * @method setSelectedSectorDatos
     * @description
     * Actualiza el arreglo de sectores seleccionados en el estado.
     * @param {FilaSectors[]} selectedSectorDatos - Nuevo arreglo de sectores seleccionados.
     * @returns {void}
     */
    public setSelectedSectorDatos(selectedSectorDatos: FilaSectors[]): void {
      this.update((state) => ({ ...state, selectedSectorDatos }));
    }
  /**
   * @constructor
