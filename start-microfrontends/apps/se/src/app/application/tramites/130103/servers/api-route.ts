 ...
 */
const PROCEDURE = '/sat-t130103';

/**
 * Rutas de la API para el procedimiento 130103
 */
export const PROC_130103 = {
    ...
    BUSCAR: `${BASE_URL}${API}${PROCEDURE}/solicitud/esquema`,
    ...
    API_POST_MOSTRAR: (TRAMITE: number, idSolicitud: number): string => `sat-t${TRAMITE}/solicitud/mostrar/${idSolicitud}`,
};
