/**
 * Conjunto de rutas de la API para el procedimiento 130116.
 */
 ...
 */
const PROCEDURE = '/sat-t130116';

/**
 * Rutas de la API para el procedimiento 130116
 */
export const PROC_130116 = {
  /** Ruta para obtener el catálogo de representaciones federales */
  REPRESENTACION_FEDERAL_CATALOGO: `${BASE_URL}${API}${PROCEDURE}/catalogo/representacion-federal/`,
