 ...
 */
export const API_POST_SOLICITUD = 'sat-t130401/solicitud/guardar';

/**
 * Rutas de la API para el procedimiento 130401
 */
export const PROC_130401 = {
  
  GET_FORM_DATA: `${BASE_URL}${API}${API_VERSION}${PROCEDURE}${SOLICITUD}/acuse`,

  OBTENER_CERTIFICADOS: `${BASE_URL}${API}${PROCEDURE}/solicitud/obtener-certificados/202738084`,

  OBTENER_LICITACIONES: (rfc: string): string =>
    `${BASE_URL}${API}${PROCEDURE}/solicitud/obtener-licitacion/${rfc}`,
