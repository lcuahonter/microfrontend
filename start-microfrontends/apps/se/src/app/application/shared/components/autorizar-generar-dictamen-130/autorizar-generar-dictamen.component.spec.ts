...
import { AutorizarGenerarDictamen130Component } from './autorizar-generar-dictamen.component';
...
describe('AutorizarGenerarDictamen130Component', () => {
    let component: AutorizarGenerarDictamen130Component;
    let fixture: ComponentFixture<AutorizarGenerarDictamen130Component>;
    let validacionesService: ValidacionesFormularioService;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [AutorizarGenerarDictamen130Component, ReactiveFormsModule],
            providers: [
                FormBuilder,
                {
        ...
        fixture = TestBed.createComponent(AutorizarGenerarDictamen130Component);
    ...
    it('debe validar que mensajeDictamen no acepte solo espacios', () => {
        ...
        control?.setValue('    ');
        expect(AutorizarGenerarDictamen130Component.noSoloEspacios(control!)).toEqual({ soloEspacios: true });
        control?.setValue('Texto válido');
        expect(AutorizarGenerarDictamen130Component.noSoloEspacios(control!)).toBeNull();
    });
