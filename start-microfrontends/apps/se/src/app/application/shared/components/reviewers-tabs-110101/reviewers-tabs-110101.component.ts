...
import { DatosEvaluacionComponent } from '../../../tramites/110102/pages/datos-evaluacion/datos-evaluacion.component';
...
import { Pantallas110101Module } from '../../../tramites/110101/pantallas/pantallas.module';
 ...
 */@Component({
  ...
  standalone: true,
  imports: [CommonModule, DocumentosComponent, Pantallas110101Module, TabDictamenComponent, TabRequerimientoComponent, TabOpinionComponent, BandejaAcusesComponent, TareasTramiteComponent, EnvioDigitalComponent, DatosEvaluacionComponent],
