...
/**
 * API para guardar la atención del requerimiento
 * @see https://api-v30.cloud-ultrasist.net/api/tramite-flujo/swagger-ui/index.html#/Atender-Requerimiento/atender-requerimiento-guardar
 */
export const API_POST_ATENCION_REQUERIMIENTO = `sat-t${TRAMITE}/tramite/${NUMFOLIOTRAMITE}/requerimiento/atender/guardar`;
