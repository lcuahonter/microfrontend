...
import { DocumentoOficialRequest, ObservacionRequest } from '../../models/autorizar-requerimiento/request/observacion-guardar-request.model';
...
export class AutorizarRequerimientoService {
  ...
  */
  postOficioAutorizacion(
    tramite: number,
    idSolicitud: number,
    PAYLOAD: DocumentoOficialRequest
  ...
  return this.http.post<BaseResponse<DocumentoOficialResponse>>(ENDPOINT, PAYLOAD);
}
