...
/** IniciarVerificarResponse */
export interface IniciarVerificarResponse {
    /** ID del dictamen */
    id_dictamen: number;
    ...
    numero_folio_alterno: string | number |null;
    ...
    uso_autorizado_dictamen:string | null;
    descripcion_uso_autorizado:string | null;
    id_restriccion_tipo_tramites:string[] | [];
    plazo_vigencia:number | null;
    fechaFinVigencia:string | null;
    justificacion_negativa:string | null;
    observacion:string | null;
    id_motivo_tipo_tramites:string[] | [];
    numMuestras:string | null;
    siglas_dictaminador:string | null;
    numero_generico_1:string | null;
    ...
    usoAutorizadoDictamen?: string;
    plazoVigencia?: string;
    justificacionNegativa?: string;
