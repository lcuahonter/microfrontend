 ...
 * Este componente interactúa con el estado del trámite a través del store `Tramite260902Store`.
 */
@Component({
...
export class PagoDeDerechosContenedoraComponent implements OnInit, OnDestroy, OnChanges {
  ...
  pagoDeDerechosComponent!: PagoDeDerechosComponent;
   ...
   /**
     ...
     */
    public readonly idProcedimiento = 260902;
   ...
   * Inicializa el store `Tramite260902Store` para gestionar el estado del trámite y el query `ConsultaioQuery`
   ...
   */
  constructor(
    public tramiteStore: Tramite260902Store,
