...
describe('ModificacionPermisoSanitario', () => {
  ...
  it('debería obtener los datos de registro de toma de muestras', () => {
    ...
    expect(httpMock.get).toHaveBeenCalledWith('assets/json/260902/serviciosExtraordinarios.json');
  });
  ...
  it('debería obtener los datos de pago de derechos', () => {
    ...
    expect(httpMock.get).toHaveBeenCalledWith('assets/json/260902/pagoDerechos.json');
  });
});