...
/**
 * @interface
 * @name Tramite260902State
 * @description
 * Representa el estado de la tienda para el trámite 260902. Contiene datos relacionados
 * con destinatarios, facturadores, proveedores, fabricantes, formularios y configuraciones.
 */
/**
 * Representa el estado de la gestión del trámite 260902.
 */
export interface Tramite260902State {
  /**
 ...
 * @description
 * Crea el estado inicial para la tienda del trámite 260902.
 * @returns {Tramite260902State} Estado inicial.
 */
export function createInitialState(): Tramite260902State {
  return {
    idSolicitud: 0,
...
@StoreConfig({ name: 'tramite260902', resettable: true })
/**
 * @class
 * @name Tramite260902Store
 * @description
 * Tienda para manejar el estado del trámite 260902. Proporciona métodos para actualizar
 * diferentes partes del estado.
 * @extends {Store<Tramite260902State>}
 */
export class Tramite260902Store extends Store<Tramite260902State> {
  constructor() {
