...
@Injectable()
class MockTramite260911Store { }

@Injectable()
class MockTramite260911Query { }
...
describe('TercerosRelacionadosVistaComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: Tramite260911Store, useClass: MockTramite260911Store },
        { provide: Tramite260911Query, useClass: MockTramite260911Query },
