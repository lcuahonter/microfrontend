...
export class ContenedorDeDatosSolicitudComponent implements OnInit, OnDestroy {
   ...
   *
   * @param {Tramite260214Query} tramite260215Query - Consulta para obtener el estado del trámite.
   * @param {Tramite260214Store} tramite260215Store - Store que administra el estado del trámite.
   */
  constructor(
  ...
  opcionSeleccionado(event: TablaOpcionConfig[]): void {
    ...
    this.tramite260215Store.updateOpcionConfigDatos(event);
  }
  ...
  scianSeleccionado(event: TablaScianConfig[]): void {
    ...
    this.tramite260215Store.updateScianConfigDatos(event);
  }
  ...
  mercanciasSeleccionado(event: TablaMercanciasDatos[]): void {
    ...
    this.tramite260215Store.updateTablaMercanciasConfigDatos(event);
  }
  ...
  datasolicituActualizar(event: DatosSolicitudFormState): void {
    this.tramite260215Store.updateDatosSolicitudFormState(event);
  }
