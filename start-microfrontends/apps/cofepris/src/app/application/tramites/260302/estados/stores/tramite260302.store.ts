 ...
 */
export interface Solicitud260302StateUno {
    /**
 ...
 */
export function createInitialState(): Solicitud260302StateUno {
    return {
...
export class Tramite260302Store extends Store<Solicitud260302StateUno> {
    /**
