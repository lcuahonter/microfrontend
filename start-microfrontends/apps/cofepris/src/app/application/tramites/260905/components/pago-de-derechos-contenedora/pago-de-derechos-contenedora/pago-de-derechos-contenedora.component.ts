 ...
 * Este componente interactúa con el estado del trámite a través del store `Tramite260905Store`.
 */
@Component({
...
export class PagoDeDerechosContenedoraComponent implements OnInit, OnChanges, OnDestroy {
   ...
   * Inicializa el store `Tramite260905Store` para gestionar el estado del trámite y el query `ConsultaioQuery`
   ...
   *
   * @param {Tramite260905Store} tramiteStore - Store que administra el estado del trámite 260214.
   ...
   */
  constructor(
    public tramiteStore: Tramite260905Store,
