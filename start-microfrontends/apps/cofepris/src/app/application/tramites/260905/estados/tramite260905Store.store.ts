...
/**
 * @interface
 * @name Tramite260905State
 * @description
 * Representa el estado de la tienda para el trámite 260905. Contiene datos relacionados
 * con destinatarios, facturadores, proveedores, fabricantes, formularios y configuraciones.
 */
/**
 * Representa el estado de la gestión del trámite 260905.
 */
export interface Tramite260905State {
  /**
 ...
 * @description
 * Crea el estado inicial para la tienda del trámite 260905.
 * @returns {Tramite260905State} Estado inicial.
 */
export function createInitialState(): Tramite260905State {
  return {
    idSolicitud: 0,
...
@StoreConfig({ name: 'tramite260905', resettable: true })
/**
 * @class
 * @name Tramite260905Store
 * @description
 * Tienda para manejar el estado del trámite 260905. Proporciona métodos para actualizar
 * diferentes partes del estado.
 * @extends {Store<Tramite260905State>}
 */
export class Tramite260905Store extends Store<Tramite260905State> {
  constructor() {
