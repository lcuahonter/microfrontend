 ...
 */
export interface Solicitud261101State {
    /**
...
/**
 * Crea el estado inicial del formulario Solicitud261101.
 * @returns Estado inicial con todos los campos definidos como cadenas vacías.
 */
export function createInitialState(): Solicitud261101State {
    return {
...
export class Tramite261101Store extends Store<Solicitud261101State> {
    /**
     * Crea una instancia de Tramite261101Store.
     * @constructor
     */
    constructor() {
