/**
 * Conjunto de rutas de la API para el procedimiento 261401.
 */
 ...
 */
const PROCEDURE = '/sat-t261401';

/**
 * Rutas de la API para el procedimiento 261401
 */
export const PROC_261401 = {
