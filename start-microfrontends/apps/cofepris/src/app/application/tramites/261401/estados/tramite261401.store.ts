...
/**
 * Interfaz que representa el estado de Solicitud261401.
 */
export interface Solicitud261401State {
  /** Permite definir propiedades dinámicas en el estado. */
  [key: string]: unknown;
  /** Indica la validez de diferentes secciones del formulario. */
  formValidity?: {
    formSectionValid?: boolean;
  ...
  manifiestos: boolean;
  /**
   * El valor de unidadMedidaTarifa.
   */
  unidadMedidaTarifa: string;
  /** Configuración de MercanciasDatos. */
  mercanciaTabla?: MercanciasDatos[];
  /** Configuración de ScianDatos. */
  scianTabla: ScianDatos[];
  /** Configuración de tabla de destinatarios (terceros relacionados). */
...
/**
 * Función para crear el estado inicial de Solicitud261401State.
 * @returns {Solicitud261401State} El estado inicial de Solicitud260211State.
 */
...
export class Tramite261401Store extends Store<Solicitud261401State> {
    ...
    /**
     * Obtiene el valor actual de observaciones.
     */
    public getObservaciones(): string | undefined {
      return this.getValue().observaciones;
    }
  /**
   ...
   */
  public establecerDatos(datos: Partial<Solicitud261401State>): void {
    this.update((state) => ({
      ...state,
      ...datos,
    }));
  ...
  /**
   * Establece el estado de idMercancia.
   * @param idMercancia - El valor de idMercancia.
   */
  public setIdMercancia(idMercancia: number): void {
    this.update((state) => ({
      ...state,
      idMercancia,
    }));
   ...
   */
  public setMarcaComercialODenominacionDistintiva(
    marcaComercialODenominacionDistintiva: string
  ): void {
    this.update((state) => ({
      ...state,
  ...
  /**
   * Establece el estado de paisOrigen.
   * @param paisOrigen - El valor de paisOrigen.
   */
   ...
   */
  public setDescripcionDelNumeroDePiezas(
    descripcionDelNumeroDePiezas: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosDenominacionSocial(
    tercerosRelacionadosDenominacionSocial: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosTerceroNombre(
    tercerosRelacionadosTerceroNombre: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosRazonSocial(
    tercerosRelacionadosRazonSocial: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosEstado(
    tercerosRelacionadosEstado: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosCodigoPostal(
    tercerosRelacionadosCodigoPostal: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosNumeroExterior(
    tercerosRelacionadosNumeroExterior: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosNumeroInterior(
    tercerosRelacionadosNumeroInterior: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosTelefono(
    tercerosRelacionadosTelefono: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosCorreoElectronico(
    tercerosRelacionadosCorreoElectronico: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setDatosPersonalesPrimerApellido(
    datosPersonalesPrimerApellido: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setDatosPersonalesSegundoApellido(
    datosPersonalesSegundoApellido: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosMunicipio(
    tercerosRelacionadosMunicipio: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosLocalidad(
    tercerosRelacionadosLocalidad: string
  ): void {
    this.update((state) => ({
      ...state,
   ...
   */
  public setTercerosRelacionadosColonia(
    tercerosRelacionadosColonia: string
  ): void {
    this.update((state) => ({
      ...state,
  ...
  /**
   * Establece el estado de unidadMedidaTarifa.
   * @param unidadMedidaTarifa - El valor de unidadMedidaTarifa.
   */
  public setUnidadMedidaTarifa(unidadMedidaTarifa: string): void {
    this.update((state) => ({
      ...state,
      unidadMedidaTarifa,
    }));
   ...
   */
  public setmercanciaTabla(mercanciaTabla: MercanciasDatos[]): void {
    this.update((STATE) => {
      const LISTAEXISTENTE = STATE.mercanciaTabla || [];
      const NUEVOARTICULO = { ...mercanciaTabla[0] };

      if (NUEVOARTICULO.idMercancia === 0) {
        // Agregar nuevo elemento con una identificación generada
        NUEVOARTICULO.idMercancia = (LISTAEXISTENTE.length || 0) + 1;
      ...
      const UPDATEDLIST = LISTAEXISTENTE.map((ITEM) =>
        ITEM.idMercancia === NUEVOARTICULO.idMercancia
          ? { ...ITEM, ...NUEVOARTICULO }
          : ITEM
      );
      return { ...STATE, mercanciaTabla: UPDATEDLIST };
  ...
  /** Establece el estado de publico.
   * @param publico - El valor de publico.
   */
  public setPublico(publico: string): void {
    this.update((state) => ({
      ...state,
      publico,
    }));
  ...
  /** Actualiza el valor de un campo dinámico en el estado.
  ...
  /**
   * Actualiza la tabla de destinatarios (terceros relacionados) en el almacén.
   * @param destinatarios Array de objetos `Destinatario` que representa la tabla de destinatarios.
   */
  public setDestinatarios(destinatarios: Destinatario[]): void {
    this.update((state) => ({
      ...state,
      destinatarios,
    }));
  ...
  /**
   * Añade un nuevo destinatario a la tabla de destinatarios.
   * @param destinatario Objeto `Destinatario` que se añadirá a la tabla.
   */
  public addDestinatario(destinatario: Destinatario): void {
    this.update((state) => {
      const LISTA_EXISTENTE = state.destinatarios || [];
      return {
        ...state,
        destinatarios: [...LISTA_EXISTENTE, destinatario],
      };
    });
  }

  /**
   * Actualiza un destinatario específico en la tabla de destinatarios.
   * @param index Índice del destinatario a actualizar.
   * @param destinatario Objeto `Destinatario` actualizado.
   */
  public updateDestinatario(index: number, destinatario: Destinatario): void {
    this.update((state) => {
      const LISTA_EXISTENTE = [...(state.destinatarios || [])];
      if (index >= 0 && index < LISTA_EXISTENTE.length) {
        LISTA_EXISTENTE[index] = destinatario;
      }
      return {
        ...state,
        destinatarios: LISTA_EXISTENTE,
      };
    });
  }
   ...
   * @param index Índice del destinatario a eliminar.
   */
  public removeDestinatario(index: number): void {
    this.update((state) => {
      const LISTA_EXISTENTE = [...(state.destinatarios || [])];
      if (index >= 0 && index < LISTA_EXISTENTE.length) {
        LISTA_EXISTENTE.splice(index, 1);
      }
      return {
        ...state,
        destinatarios: LISTA_EXISTENTE,
