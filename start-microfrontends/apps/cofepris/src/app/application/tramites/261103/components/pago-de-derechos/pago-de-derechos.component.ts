...
import { PagoDeDerechosComponent } from '../../../../shared/components/261/pago-de-derechos-new/pago-de-derechos.component';
...
export class PagoDeDerechosContenedoraComponent implements OnDestroy, OnChanges, OnInit {
  ...
  ngOnInit(): void {
    this.tramiteQuery.selectTramite261103$
   ...
   /**
     ...
     */
    public readonly idProcedimiento = 261103
   ...
   */
  constructor(
    public tramiteStore: DatosProcedureStore,
    private tramiteQuery: DatosProcedureQuery,
