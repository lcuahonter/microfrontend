...
import { DatoSCIAN, PagoDeDerechos, PatchDatoScian } from '../../260214/mostra-api/mostra';
import { Facturador, PagoDerechosFormState, Proveedor } from '../../../shared/models/terceros-relacionados.model';
import { DatosSolicitudFormState, TablaMercanciasDatos } from '../../../shared/models/datos-solicitud.model';
import { Destinatario, Fabricante } from '@libs/shared/data-access-user/src';
...
export class GuardarAdapter_260217 {
  ...
  static toPatchPagoDerechos(pagoDerechos:PagoDeDerechos):PagoDerechosFormState {
    if (!pagoDerechos) {
      return {} as PagoDerechosFormState;
    }
      return {
  ...
  static toPatchDatosSolicitudFormState(datos:any):DatosSolicitudFormState{
      ...
      return GuardarAdapter_260217.toPatchDatosSolicitudFormStateCrt(datos);
  ...
  entidadFederativa: proveedor.domicilio.entidadFederativa.nombre || '',
  ...
  static toPatchValueStore(datos:any):any{
      return {
          datosSolicitudFormState: GuardarAdapter_260217.toPatchDatosSolicitudFormState(datos),
          scianConfigDatos:GuardarAdapter_260217.toPatchDatoscian(datos.datosSCIAN),
          pagoDerechos:GuardarAdapter_260217.toPatchPagoDerechos(datos.pagoDeDerechos),
          fabricanteTablaDatos:GuardarAdapter_260217.toPatchfabricanteTablaDatos(datos),
          destinatarioFinalTablaDatos:GuardarAdapter_260217.toPatchDestinatario(datos),
          proveedorTablaDatos:GuardarAdapter_260217.toPatchproveedorTablaDatos(datos),
          facturadorTablaDatos:GuardarAdapter_260217.toPatchfacturadorTablaDatos(datos),
          tablaMercanciasConfigDatos:GuardarAdapter_260217.toPatchtablaMercanciasConfigDatos(datos)
