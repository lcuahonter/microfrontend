...
describe('DatosSolicitudComponent (Jest)', () => {
  ...
  let store: MockTramite260510Store;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, DatosSolicitudComponent, DatosDeLaComponent],
      providers: [
        { provide: Tramite260510Store, useClass: MockTramite260510Store },
      ],
    }).compileComponents();
    ...
    store = TestBed.inject(Tramite260510Store) as unknown as MockTramite260510Store;
