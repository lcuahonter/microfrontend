import { DatosSolicitudFormState, TablaMercanciaClaveConfig } from '../../../../shared/components/shared2607/models/datos-solicitud.model';
import { PRODUCTO_TABLA_DATA, TIPO_ACTUALIZACION } from '../../../../shared/constantes/datos-solicitud.enum';
import { Destinatario } from '../../../../shared/components/shared2607/models/terceros-relacionados.model';
import { Fabricante } from '../../../../shared/components/shared2607/models/terceros-relacionados.model';
import { Facturador } from '../../../../shared/components/shared2607/models/terceros-relacionados.model';
import { Injectable } from '@angular/core';
import { MercanciaForm } from '../../../../shared/components/shared2607/models/datos-solicitud.model';
import { PagoDerechosFormState } from '../../../../shared/components/shared2607/models/terceros-relacionados.model';
import { Proveedor } from '../../../../shared/components/shared2607/models/terceros-relacionados.model';
...
import { TablaOpcionConfig } from '../../../../shared/components/shared2607/models/datos-solicitud.model';
import { TablaScianConfig } from '../../../../shared/components/shared2607/models/datos-solicitud.model';
import { TablaDatos } from '../../../../shared/models/terceros-fabricante.model';
import { DestinatarioModel, FacricanteModel } from '../../../../shared/models/terceros-fabricante-relocionados.model';

/**
 * @interface Tramite260704State
 * @description
 ...
 */
export interface Tramite260704State {
  /**
  ...
  */
  ...
  /**
   * @property facricanteModel
   * @description Modelo completo de datos del fabricante.
   * Incluye información detallada del fabricante relacionada con el trámite.
   */
  facricanteModel?: FacricanteModel[];
  /**
   * @property destinatarioModel
   * @description Modelo completo de datos del destinatario.
   * Incluye información detallada del destinatario relacionada con el trámite.
   */
 ...
 * de pago de derechos.
 *
 * @returns {Tramite260704State} El objeto de estado inicializado con valores por defecto
 * para todos los campos requeridos en el trámite 260102.
 */
export function createInitialState(): Tramite260704State {
  return {
  idSolicitud: 0,
 ...
 * 
 * @extends Store<Tramite260704State>
 * 
 * @example
 * const store = new Tramite260704Store();
 * store.updateDatosSolicitudFormState(newFormState);
 * store.updateFabricanteTablaDatos([newFabricante]);
 */
export class Tramite260704Store extends Store<Tramite260704State> {
      ...
      return {
        ...
        fabricanteTablaDatos:
          tipoActualizacion === TIPO_ACTUALIZACION.ELIMINAR
            ? [...nuevoFabricante]
            : [
              ...Tramite260704Store.actualizarLista(
