  ...
  static toFormPayload(state: Tramite260213State): unknown {
    return {
      ...
      private static mapScianData(arr?: any[]): any[] {
        ...
        /**
         * Map an API response (form payload) back into a partial Tramite260213State.
         ...
         * @returns Partial<Tramite260213State>
         */
        // eslint-disable-next-line complexity
        static fromApiResponse(response: unknown): Partial<Tramite260213State> {
            ...
            const PARTIAL: Partial<Tramite260213State> = {
         ...
         * @param store Optional Tramite260213Store instance to apply the patch
         * @returns Partial<Tramite260213State> (and patches the store when provided)
         */
        static patchToStore(response: any, store?: Tramite260213Store): Partial<Tramite260213State> {
            const PARTIAL = GuardarAdapter_260213.fromApiResponse(response);
            if (store) {
