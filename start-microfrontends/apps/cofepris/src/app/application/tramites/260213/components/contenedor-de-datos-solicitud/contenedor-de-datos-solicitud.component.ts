 ...
 * la visualización y manipulación de datos relacionados con la solicitud del trámite 260213.
 *
...
export class ContenedorDeDatosSolicitudComponent implements OnInit, OnDestroy {
   ...
   * 
   * @param {tramite260213Store} tramiteStore - Store que contiene el estado del trámite 260204.
  ...
  constructor(
    ...
    .subscribe((seccionState) => {
      if(!seccionState.create && seccionState.procedureId === '260213') {
