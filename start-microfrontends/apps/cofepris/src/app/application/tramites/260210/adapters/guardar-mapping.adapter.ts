  ...
  static toFormPayload(state: Tramite260210State): unknown {
    return {
      ...
      "mercancias": (state.tablaMercanciasConfigDatos ?? []).map((mercancia) => {
        return {
              ...
              "formaFarmaceuticaDescripcionOtros": mercancia.especifiqueForma || 'Tableta',
              "estadoFisicoDescripcionOtros": mercancia.especifiqueEstado ||'Sólido',
              "fraccionArancelaria": {
            ...
            "cantidadUMTConComas": mercancia.cantidadUmtValor,
              ...
              "registroSanitarioConComas": mercancia.numeroRegistroSanitario || "COFEPRIS-REG-001-2024-SSA1",
               "nombreCortoPaisOrigen": mercancia.paisOrigenDatosClave,
              "nombreCortoPaisProcedencia": mercancia.paisProcedenciaDatosClave,
              "tipoProductoDescripcionOtros": mercancia.especifique ||'Analgésico',
    ...
    private static mapMercanciasData(arr?: any[]): any[] {
        ...
        return (arr ?? []).map((m: any) => ({
            ...
            formaFarmaceutica: m.formaFarmaceuticaDescripcionOtros ?? 'Tableta',
