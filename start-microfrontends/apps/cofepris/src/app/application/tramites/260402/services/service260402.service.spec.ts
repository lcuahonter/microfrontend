...
describe('Solocitud260402Service', () => {
  ...
  beforeEach(() => {
    ...
    service = new Solocitud260402Service(
      httpMock,
      datosStoreMock,
      permisoStoreMock,
      datosQueryMock,
  ...
  describe('getRegistroTomaMuestrasMercanciasData', () => {
    it('debe llamar a http.get con la URL correcta y retornar su observable', done => {
      ...
      service.getRegistroTomaMuestrasMercanciasData().subscribe(res => {
        ...
        expect(httpMock.get).toHaveBeenCalledWith('assets/json/260402/serviciosExtraordinarios.json');
        done();
      });
    });
  });
  ...
  describe('getPagoDerechos', () => {
    it('debe llamar a http.get con la URL correcta y retornar su observable', done => {
      ...
      service.getPagoDerechos().subscribe(res => {
        expect(res).toEqual(mockResponse);
        expect(httpMock.get).toHaveBeenCalledWith('assets/json/260402/pagoDerechos.json');
        done();
      });
    });
  });
