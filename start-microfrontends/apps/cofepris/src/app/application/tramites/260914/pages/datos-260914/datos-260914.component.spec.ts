...
import { Datos260914Component } from './datos-260914.component';
...
describe('PasoUnoComponent', () => {
  let component: Datos260914Component;
  let fixture: ComponentFixture<Datos260914Component>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [Datos260914Component],
      imports: [ require('@angular/common/http/testing').HttpClientTestingModule],
      providers: [
        { provide: ConsultaioQuery, useValue: consultaQueryMock },
        { provide: Datos260914Component, useValue: servicioMock }
      ],
      schemas: [NO_ERRORS_SCHEMA]
    }).compileComponents();

    fixture = TestBed.createComponent(Datos260914Component);
