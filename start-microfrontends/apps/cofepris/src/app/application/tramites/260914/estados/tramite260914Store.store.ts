...
/**
 * @interface
 * @name Tramite260914State
 * @description
 * Representa el estado de la tienda para el trámite 260914. Contiene datos relacionados
 * con destinatarios, facturadores, proveedores, fabricantes, formularios y configuraciones.
 */
/**
 * Representa el estado de la gestión del trámite 260914.
 */
export interface Tramite260914State {
  /**
 ...
 * @description
 * Crea el estado inicial para la tienda del trámite 260914.
 * @returns {Tramite260914State} Estado inicial.
 */
export function createInitialState(): Tramite260914State {
  return {
    idSolicitud: 0,
...
@StoreConfig({ name: 'tramite260914', resettable: true })
/**
 * @class
 * @name Tramite260914Store
 * @description
 * Tienda para manejar el estado del trámite 260914. Proporciona métodos para actualizar
 * diferentes partes del estado.
 * @extends {Store<Tramite260914State>}
 */
export class Tramite260914Store extends Store<Tramite260914State> {
  constructor() {
