...
import { Solocitud260914Service } from './service260914.service';
import { HttpClient } from '@angular/common/http';
import { of } from 'rxjs';

describe('Solocitud260914Service', () => {
  let service: Solocitud260914Service;
  let httpMock: any;
  ...
  beforeEach(() => {
    ...
    service = new Solocitud260914Service(
      httpMock as any,
  ...
  it('debería obtener los datos de registro de toma de muestras', () => {
    ...
    expect(httpMock.get).toHaveBeenCalledWith('assets/json/260914/serviciosExtraordinarios.json');
  });
  ...
  it('debería obtener los datos de pago de derechos', () => {
    ...
    expect(httpMock.get).toHaveBeenCalledWith('assets/json/260914/pagoDerechos.json');
  });
});