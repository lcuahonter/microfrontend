import {
  Tramite260914State,
  Tramite260914Store,
} from './tramite260914Store.store';
import { Injectable } from '@angular/core';
import { Query } from '@datorama/akita';

/**
 * @class
 * @name Tramite260914Query
 * @description
 ...
 *
 * @extends {Query<Tramite260914State>}
 */
@Injectable({ providedIn: 'root' })
export class Tramite260914Query extends Query<Tramite260914State> {
  /**
   * @constructor
   * @description
   * Inicializa la consulta con la tienda correspondiente.
   *
   * @param {Tramite260914Store} store - La tienda que contiene el estado del trámite 260201.
   */
  constructor(protected override store: Tramite260914Store) {
    super(store);
  }
  /**
   * @property {Observable<Tramite260914State>} selectTramiteState$
   * @description
