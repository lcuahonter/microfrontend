...
import { OperacionDeMaquilaSubmaquilaRoutingModule } from './operacion-de-maquila-submaquila-routing.module';
...
@NgModule({
 declarations: [PasoUnoComponent,
   ...
   imports: [
     CommonModule,
     OperacionDeMaquilaSubmaquilaRoutingModule,
     SolicitanteComponent,
     BtnContinuarComponent,
     WizardComponent,
     SolicitanteComponent,
...
export class OperacionDeMaquilaSubmaquilaModule { }
