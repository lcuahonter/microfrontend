...
import { TablaMercanciasDatos, TablaScianConfig} from '../../../shared/models/2603/datos-solicitud.model';
...
export class Tramite260303Store extends Store<Solicitud260303State> {
   ...
   */
  public establecerDatos(datos: Partial<Solicitud260303State>): void {
    this.update((state) => ({
      ...state,
      ...datos,
    }));
