...
export class TercerosRelacionadosVistaComponent
  ...
  /**
   * Indica si los botones de acción deben mostrarse en la vista.
   * Se activa, por ejemplo, para permitir acciones adicionales como prórroga según el tipo de trámite.
   */
   ...
   * Actualiza el estado de visibilidad, habilitación de tablas y botones de acción según el tipo de trámite y procedimiento.
   * @param _changes Cambios detectados en las propiedades de entrada (SimpleChanges)
   */
  ngOnChanges(_changes: SimpleChanges): void {
    this.estaOculto = false;
    if (
      (this.tipoTramite === '1' || this.tipoTramite === '2') &&
      this.idProcedimiento === 260910
    ) {
