...
import { Tramite260910State, Tramite260910Store } from './tramite260910Store.store';
import { Injectable } from '@angular/core';
import { Query } from '@datorama/akita';

/**
 * @class
 * @name Tramite260910Query
 * @description
 * Clase que proporciona consultas para acceder al estado del trámite 260910.
 * Extiende la clase `Query` de Akita para realizar selecciones del estado almacenado.
 *
 * @extends {Query<Tramite260910State>}
 */
@Injectable({ providedIn: 'root' })
export class Tramite260910Query extends Query<Tramite260910State> {
   ...
   *
   * @param {Tramite260910Store} store - La tienda que contiene el estado del trámite 260910.
   */
  constructor(protected override store: Tramite260910Store) {
    super(store);
  }

  /**
   * @property {Observable<Tramite260910State>} selectTramiteState$
   * @description
   * Selecciona el estado completo del trámite 260910.
   */
