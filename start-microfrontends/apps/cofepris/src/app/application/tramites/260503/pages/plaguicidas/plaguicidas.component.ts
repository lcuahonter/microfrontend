...
import { ListaPasosWizard, Notificacion, PASOS, WizardService, doDeepCopy, esValidObject, getValidDatos } from '@libs/shared/data-access-user/src';
 ...
 */
 ...
 public isFormValid: boolean = false;
   ...
   * Actualiza el índice y los datos del paso en consecuencia.
   */
