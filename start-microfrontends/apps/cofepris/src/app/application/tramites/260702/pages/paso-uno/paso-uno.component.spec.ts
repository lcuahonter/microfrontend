...
describe('PasoUnoComponent', () => {
  ...
  let solicitud260702Store: Solicitud260702Store;
  let solicitud260702Query: Solicitud260702Query;
  ...
  beforeEach(async () => {
    ...
    solicitud260702Store = TestBed.inject(Solicitud260702Store);
    solicitud260702Query = TestBed.inject(Solicitud260702Query);
  ...
  it('debería manejar el cambio de validez del formulario', () => {
    const spy = jest.spyOn(solicitud260702Store, 'setFormValidity');
  ...
  it('debería cargar datos y actualizar el estado del formulario en guardarDatosFormulario', () => {
  ...
  it('debería destruir correctamente el componente y limpiar destroyNotifier$', () => {
