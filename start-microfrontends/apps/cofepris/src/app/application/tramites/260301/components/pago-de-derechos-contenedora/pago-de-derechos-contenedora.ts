...
public idProcedimiento = 260301;
   ...
   */
  constructor(
    public tramiteStore: TramiteProc260301Store ,
   ...
   * @access public
   */
  updatePagoDerechosUNO(event: PagoDerechosFormState): void {
  ...
  private flattenAndSet(obj: any): void {
    Object.keys(obj).forEach(key => {
      if (typeof obj[key] === 'object' && obj[key] !== null && !Array.isArray(obj[key])) {
        ...
        this.tramiteStore.setDynamicFieldValue(key, obj[key]);
      }
    });
  }

    public updatePagoDerechos(event: PagoDerechosFormState): void {
   ...
   */
  markTouched(): void {
    this.pagoDeDerechosComponent.markTouched();
  }
  /**
