 ...
 * 
 * @interface Solicitud260301State
...
/**
 * Crea el estado inicial para Solicitud260301State.
 * @returns {Solicitud260301State} Un objeto vacío que representa el estado inicial del estado de Solicitud260301State.
 */
...
export class Tramite260301Store extends Store<Solicitud260301State> {
    ...
    /**
     * Constructor de la clase Tramite260301Store.
     * 
