...
const mockTramite260507Store = {
  setContinuarTriggered: jest.fn(),
  setIdSolicitud: jest.fn(),
};
const mockTramite260507Query = {
...
describe('PantallasComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: Tramite260507Store, useValue: mockTramite260507Store },
        { provide: Tramite260507Query, useValue: mockTramite260507Query },
  ...
  it('should store id_solicitud on guardar()', async () => {
    ...
    expect(mockTramite260507Store.setIdSolicitud).toHaveBeenCalledWith(123);
  });
});
