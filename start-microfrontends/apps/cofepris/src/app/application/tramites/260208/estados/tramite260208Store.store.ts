...
/**
 * @interface Tramite260208State
 * Representa el estado completo de la solicitud para el trámite 260208.
 */
...
export function createInitialState(): Tramite260208State {
  return {
    ...
    datosSolicitudFormState: {
      // Datos iniciales del formulario de solicitud.
      rfcSanitario: '',
      denominacionRazon: '',
      correoElectronico: '',
      codigoPostal: '',
    ...
    mercanciaForm: {
      // Datos iniciales para la mercancía.
    ...
    pagoDerechos: {
      // Datos iniciales del pago de derechos.
      claveReferencia: '',
      cadenaDependencia: '',
      estado: '',
      llavePago: '',
...
export class Tramite260208Store extends Store<Tramite260208State> {
  /**
   * @constructor
   * Inicializa el store `Tramite260208Store` con el estado inicial de la solicitud.
   */
  constructor() {
