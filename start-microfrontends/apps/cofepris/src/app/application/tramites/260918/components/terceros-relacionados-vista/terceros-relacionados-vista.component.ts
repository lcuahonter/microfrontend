...
export class TercerosRelacionadosVistaComponent implements OnInit, OnChanges, OnDestroy {
   ...
   /**
     ...
     * @description Identificador del procedimiento, recibido como input del padre.
     */
     @Input() idProcedimiento!: 260918;
  ...
  botonDesactivarParaProrrogar: boolean = false;
    ...
    /**
     * Indica si se deben mostrar los botones de acción en la vista de terceros relacionados.
     * @remarks
     * Esta propiedad controla la visibilidad de los botones de acción en el componente.
     */
  ...
  constructor(
    private tramiteStore: Tramite260918Store,
         private tramiteQuery: Tramite260918Query, 
     ...
     * 
     * Este método actualiza el estado de visibilidad y habilitación de tablas y botones de acción
     * según el valor de `tipoTramite`. Si `tipoTramite` es '1' o '2', habilita las tablas y muestra los botones de acción;
     * en caso contrario, deshabilita las tablas y oculta los botones.
     */
