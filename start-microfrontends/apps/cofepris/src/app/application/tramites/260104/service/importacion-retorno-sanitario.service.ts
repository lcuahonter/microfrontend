...
import { PROC_260104 } from '../servers/api.route';
...
export class ImportacionRetornoSanitarioService {
   ...
   * @private
   */
  private jsonUrl = 'assets/json/260104/';
   ...
   */
  constructor(public httpServicios: HttpClient,private tramite260104Store: Tramite260104Store) {
   ...
   */
  actualizarEstadoFormulario(datos: Tramite260104Store): void {
   ...
   */
  getTramiteDatos(): Observable<Tramite260104Store> {
    return this.httpServicios.get<Tramite260104Store>('assets/json/260104/respuestaDeActualizacionDe.json');
  }

  getRegistroTomaMuestrasMercanciasData(id: string): Observable<JSONResponse> {
    return this.httpServicios.get<JSONResponse>(PROC_260104.MOSTRA(id));
  }
