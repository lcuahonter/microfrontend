 ...
 * Este componente interactúa con el estado del trámite a través del store `Tramite260104Store`.
 */
@Component({
 ...
 */
  ...
  /**
   * @constructor
   * @description Constructor que inyecta el store `Tramite260104Store` para gestionar el estado del trámite.
   * Inicializa la propiedad `pagoDerechos` con el valor actual del store.
   *
   * @param tramiteStore - Store que administra el estado del trámite 260104.
   */
  constructor(public tramiteStore: Tramite260104Store,private consultaQuery: ConsultaioQuery) {
