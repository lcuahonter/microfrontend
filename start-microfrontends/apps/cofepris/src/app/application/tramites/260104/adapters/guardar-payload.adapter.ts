...
import { Tramite260104State } from '../estados/tramite260104Store.store';
...
export class GuardarAdapter_260104 {
  /**
   ...
   */
  static toFormPayload(state: Tramite260104State): unknown {
    return {
  "solicitante": {
        "rfc": "AAL0409235E6",
