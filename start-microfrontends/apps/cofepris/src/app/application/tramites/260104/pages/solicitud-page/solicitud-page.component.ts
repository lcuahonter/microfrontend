import { AVISO, AccionBoton, DatosPasos, ListaPasosWizard, Notificacion, PASOS, RegistroSolicitudService, WizardComponent, esValidObject,getValidDatos } from '@libs/shared/data-access-user/src';
import { Component, EventEmitter, OnInit, ViewChild } from '@angular/core';
import { MENSAJE_DE_VALIDACION, TITULOMENSAJE } from '../../constants/importacion-retorno-sanitario.enum';
import { Tramite260104State, Tramite260104Store } from '../../estados/tramite260104Store.store';
import { GuardarAdapter_260104 } from '../../adapters/guardar-payload.adapter';
...
export class SolicitudPageComponent implements OnInit {
  ...
  */
   ...
   constructor(public registroSolicitudService: RegistroSolicitudService,private tramite260104Query: Tramite260104Query, private tramite260104Store: Tramite260104Store,
   ...
   ngOnInit(): void {
         this.tramite260104Query.selectTramiteState$.pipe().subscribe((data) => {
       this.storeData = data;
     });
   }
   /**
     ...
     static obtenerNombreDelTítulo(valor: number): string {
        ...
        */
        postGuardarDatos(e: AccionBoton): void {
               const PAYLOAD = GuardarAdapter_260104.toFormPayload(this.storeData);
                 let shouldNavigate = false;
                 this.registroSolicitudService.postGuardarDatos('260104', PAYLOAD).subscribe(response => {
                   ...
                   if(shouldNavigate) {
                     if(esValidObject(response) && esValidObject(response.datos)) {
                       ...
                       if(getValidDatos(DATOS.id_solicitud)) {
                         this.tramite260104Store.setIdSolicitud(DATOS.id_solicitud ?? 0);
                       } else {
                         this.tramite260104Store.setIdSolicitud(0);
                       }
                     }
