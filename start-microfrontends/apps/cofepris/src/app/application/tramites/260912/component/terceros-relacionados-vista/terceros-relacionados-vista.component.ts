...
@Component({
  selector: 'app-terceros-relacionados-vista-260912',
  standalone: true,
  imports: [CommonModule, TercerosRelacionadosModificacionComponent],
  templateUrl: './terceros-relacionados-vista.component.html'
})
export class TercerosRelacionadosVistaComponent implements OnChanges, OnInit{
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if ((this.tipoTramite === '1' || this.tipoTramite === '2') && this.idProcedimiento === 260912) {
