...
export class PagoDeDerechosContenedoraComponent implements OnInit, OnDestroy, OnChanges{
  ...
  /**
 * Referencia al componente hijo PagoDeDerechosComponent obtenida mediante ViewChild.
 ...
 */
  @ViewChild(PagoDeDerechosComponent) pagoDeDerechosComponent!: PagoDeDerechosComponent;
   ...
   /**
     ...
     */
    public readonly idProcedimiento = 260912;
...
/**
 * Se suscribe al observable selectTramite260912$ para obtener los datos del trámite.
 * Asigna la información de pago de derechos y gestiona la suscripción hasta la destrucción del componente.
 */
  ngOnInit(): void {
    this.tramiteQuery.selectTramite260912$
...
/**
 * Valida el contenedor consultando el formulario del componente PagoDeDerechosComponent.
 * Retorna false si el componente no está disponible o la validación falla.
 */
