  ...
  static toFormPayload(state: Tramite260216State): unknown {
    return {
      ...
      "pagoDeDerechos": {
        ...
        /**
         * Map an API response (form payload) back into a partial Tramite260216State.
         ...
         * @returns Partial<Tramite260216State>
         */
        // eslint-disable-next-line complexity
        static fromApiResponse(response: unknown): Partial<Tramite260216State> {
            ...
            const PARTIAL: Partial<Tramite260216State> = {
         ...
         * @param store Optional Tramite260216Store instance to apply the patch
         * @returns Partial<Tramite260216State> (and patches the store when provided)
         */
        static patchToStore(response: any, store?: Tramite260216Store): Partial<Tramite260216State> {
            const PARTIAL = GuardarAdapter_260216.fromApiResponse(response);
            if (store) {
