import { Fabricante, MercanciasDatos, Otros260303, ScianDatos } from '@libs/shared/data-access-user/src';
...
*/
    ...
    */
    ...
    /**
    * El valor de scianTabla.
    */
    scianTabla: ScianDatos[];
    fabricantetabla: Fabricante[],
    facturadorTablaDatos: any[],
    proveedorTablaDatos: any[],
    certificadoAnaliticoTablaDatos: any[],
    otrosTabla: Otros260303[],
    /**
     * El valor de mercanciasTabla.
     */
    mercanciasTabla: MercanciasDatos[];
    /**
...
export function createInitialState(): Solicitud2603State {
    return {
        ...
        proveedorTablaDatos: [],
        certificadoAnaliticoTablaDatos: [],
        otrosTabla: [],
...
export class Tramite2603Store extends Store<Solicitud2603State> {
     ...
     */
    public patchSolicitud(partial: Partial<Solicitud2603State>): void {
        this.update((state) => ({
            ...state,
            ...partial,
        }));
    ...
    /**
     * Obtiene el estado actual completo del store Tramite2603Store.
     * Puedes usar este método para acceder a todos los valores actuales del store.
     * @returns {Solicitud2603State} El estado actual del store.
     */
    public getStoreTableData(): Solicitud2603State {
        return this.getValue();
    }
    /**
         * Actualiza la tabla de facturadores en el estado del store.
         * @param tablaDato - Array que reemplazará los datos actuales.
         */
    public setFacturadores(tablaDato: any[]): void {
        this.update((state) => ({
            ...state,
            facturadorTablaDatos: tablaDato,
        }));
    }
    /**
       * Actualiza la tabla de certificados analíticos en el estado del store.
       * @param tablaDato - Array que reemplazará los datos actuales.
       */
    public setCertificadosAnaliticos(tablaDato: any[]): void {
        this.update((state) => ({
            ...state,
            certificadoAnaliticoTablaDatos: tablaDato,
        }));
    }
    /**
     * Actualiza la tabla de proveedores en el estado del store.
     * @param tablaDato - Array que reemplazará los datos actuales.
     */
    public setProveedores(tablaDato: any[]): void {
        this.update((state) => ({
            ...state,
            proveedorTablaDatos: tablaDato,
        }));
    }
    /**
     ...
     */
    public setTercerosRelacionadosDenominacionSocial(nombre: string): void {
        this.update((state) => ({
            ...state,
            nombre,
        }));
     ...
     */
    public setTercerosRelacionadosRfc(rfc: string): void {
        this.update((state) => ({
            ...state,
            rfc,
        }));
     ...
     */
    public setTercerosRelacionadosCurp(curp: string): void {
        this.update((state) => ({
            ...state,
            curp,
        }));
     ...
     */
    public setTercerosRelacionadosPais(pais: string): void {
        this.update((state) => ({
            ...state,
            pais,
        }));
     ...
     */
    public setTercerosRelacionadosEstado(estado: string): void {
        this.update((state) => ({
            ...state,
            estado,
        }));
     ...
     */
    public setTercerosRelacionadosTipoPersona(tipoPersona: string): void {
        this.update((state) => ({
            ...state,
            tipoPersona,
        }));
   ...
   * @param tercerosRelacionadosCodigoPostal - El valor de tercerosRelacionadosCodigoPostal.
   */
    public setTercerosRelacionadosNacionalidad(tercerosNacionalidad: string): void {
        this.update((state) => ({
            ...state,
            tercerosNacionalidad,
        }));
   ...
   * @param tercerosRelacionadosCodigoPostal - El valor de tercerosRelacionadosCodigoPostal.
   */
    public setTercerosRelacionadosCodigoPostal(codigoPostal: string): void {
        this.update((state) => ({
            ...state,
            codigoPostal,
        }));
     ...
     */
    public setTercerosRelacionadosCalle(calle: string): void {
        this.update((state) => ({
            ...state,
            calle,
        }));
     ...
     */
    public setTercerosRelacionadosNumeroExterior(numeroExterior: string): void {
        this.update((state) => ({
            ...state,
            numeroExterior,
        }));
     ...
     */
    public setTercerosRelacionadosNumeroInterior(numeroInterior: string): void {
        this.update((state) => ({
            ...state,
            numeroInterior,
        }));
     ...
     */
    public setTercerosRelacionadosLada(lada: string): void {
        this.update((state) => ({
            ...state,
            lada,
        }));
     ...
     */
    public setTercerosRelacionadosTelefono(telefono: string): void {
        this.update((state) => ({
            ...state,
            telefono,
        }));
     ...
     */
    public setTercerosRelacionadosCorreoElectronico(telefono: string): void {
        this.update((state) => ({
            ...state,
            telefono,
        }));
    ...
    /**  
 * Actualiza la tabla de fabricantes en el estado del store.  
 * @param tablaDato - Array de Fabricante que reemplazará los datos actuales.  
 */
    public setFabricantes(tablaDato: Fabricante[]): void {
        this.update((state) => ({
            ...state,
            fabricantetabla: tablaDato,
        }));
    }
    /**  
 * Actualiza la tabla de otros en el estado del store.  
 * @param tablaDato - Array de Otros260303 que reemplazará los datos actuales.  
 */
    public setOtros(tablaDato: Otros260303[]): void {
        this.update((state) => ({
            ...state,
            otrosTabla: tablaDato,
        }));
    }
    /**
     * Establece el estado de mercanciasTabla.
     * @param tablaDato - El valor de mercanciasTabla.
     */
    public setMercanciasTabla(tablaDato: MercanciasDatos[]): void {
        this.update((state) => ({
            ...state,
            mercanciasTabla: tablaDato,
        }));
    }
     ...
     */
    public setTercerosRelacionadosMunicipio(municipio: string): void {
        this.update((state) => ({
            ...state,
            municipio,
        }));
     ...
     */
    public setTercerosRelacionadosLocalidad(localidad: string): void {
        this.update((state) => ({
            ...state,
            localidad,
        }));
     ...
     */
    public setTercerosRelacionadosColonia(colonia: string): void {
        this.update((state) => ({
            ...state,
            colonia
        }));
