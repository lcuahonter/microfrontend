...
export const PRODUCTO_TABLA = [
  ...
  },
  {
    ...
    clave: (ele: TablaMercanciasDatos): string | undefined => Array.isArray(ele.paisDeProcedenciaDatos) ? ele.paisDeProcedenciaDatos.join(', ') : ele.paisDeProcedenciaDatos ?? '', // Reemplaza 'ele.paisProcedencia' con la clave correcta
    orden: 9,
  },
  {
    encabezado: 'País de origen',
    clave: (ele: TablaMercanciasDatos): string | undefined => Array.isArray(ele.paisDeOriginDatos) ? ele.paisDeOriginDatos.join(', ') : ele.paisDeOriginDatos ?? '', // Reemplaza 'ele.paisOrigen' con la clave correcta
    orden: 10,
  },
...
export const PRODUCTO_TABLA_301 = [
  {
    encabezado: 'Clasificación del producto',
    clave: (ele: TablaMercanciasDatos): string => ele.clasificacionProducto,
    orden: 1,
  ...
  },
  {
    ...
    clave: (ele: TablaMercanciasDatos): string | undefined =>
      ele.descripcionDelProducto ?? '', // Reemplaza 'ele.especificarClasificacionProducto' con la clave correcta
    orden: 6,
  },
  {
    encabezado: 'País de origen',
 ...
 * @type {number[]}
 */
export const PROCEDIMIENTOS_NO_PARA_ELEMENTO_COLAPSABLE = [260604, 260603];
 ...
 * }
 */
export const PROCEDIMIENTOS_NO_PARA_ELEMENTO_RFC_DEL_SANITARIO = [260604, 260603];
...
/**
 * @const REQUIRED_BANCO
 * @description Arreglo que contiene los identificadores de los procedimientos que requieren información bancaria obligatoria.
 * @type {number[]}
 */
...
export const PROCEDIMIENTOS_PARA_DESHABILITAR_RFC= [
 ...
 * @type {number[]}
 */
export const DESHABILITADA_EN_INIT = [260604, 260603];

/**
 * @const DESHABILITADA_ESTADO_EN_INIT
 * @description Lista de identificadores de procedimientos que deben tener el estado deshabilitado al iniciar.
 * @type {number[]}
 */
...
/** Mensaje emergente de confirmación para la eliminación de registros marcados.
 */
...
/**
 * @const ENABLE_FIELDS
 * @description Arreglo que contiene los identificadores de los campos que deben ser habilitados.
 * @type {number[]}
 */
export const ENABLE_FIELDS = [260601];

/** @const REQUERIDO_TELEFONO
 * @description Arreglo que contiene los identificadores de los campos donde el teléfono es requerido.
 * @type {number[]}
 */
export const REQUERIDO_TELEFONO = [260601];

/** @const HABITO_REGIMEN
 * @description Arreglo de identificadores de procedimientos para los cuales el campo "Hábito de Régimen" debe estar habilitado.
 * @type {number[]}
 */
 ...
 */
export const PROCEDIMIENTOS_NO_PARA_MANIFIESTOS_Y_DECLARACIONES:number[] = [260604, 260603];

/**
 * Constante que representa los procedimientos que son aplicables para manifiestos y declaraciones.
 * @remarks
 * Esta constante se utiliza para identificar procedimientos específicos que requieren la inclusión de manifiestos y declaraciones.
 */
export const PROCEDIMIENTOS_PARA_MANIFIESTOS_Y_DECLARACIONES:number[] = [];
...
/** @const FECHA_DE_MOVIMIENTO
 * @description Configuración del campo de fecha de movimiento para importación o exportación.
 */
 ...
 * }
 */
export const REPRESENTANTE_LEGAL_EN_INIT = [260604, 260603];
...
/** 
 * @const PAIS_DE_PROCEDENCIA_DISABLED
 * @description Lista de identificadores de procedimientos para los cuales el campo "País de procedencia" debe estar deshabilitado.
 *
 * @type {number[]}
 */
export const PAIS_DE_PROCEDENCIA_DISABLED = [260604];

export const ESCONDER_LICENCIA = [260601];

export const DENOMINACION_ESPECIFICA = [260601];
/**
 * @const RADIO_NO_SI
 * @description Arreglo de opciones para un campo de selección binaria "No" y "Si".
 * Cada opción está representada por un objeto con propiedades "label" y "value".
 */
export const RADIO_NO_SI = [  
  {
    "label": "No",
    "value": "No"
  },
...
/**
 * @const PAIS_DE_DESTINO_DISABLED
 * @description Lista de identificadores de procedimientos para los cuales el campo "País de destino" debe estar deshabilitado.
 *
 * @type {number[]}
 */
export const PAIS_DE_DESTINO_DISABLED = [260603,260601];

/**
 * @const AGREGAR_FACTURADOR_MODAL_TITULO
 * @description Lista de identificadores de procedimientos para los cuales el título del modal de agregar facturador es aplicable.
 *
 * @type {number[]}
 */
export const AGREGAR_FACTURADOR_MODAL_TITULO = [260603, 260604];

/**
 * @const MODIFICAR_FACTURADOR_MODAL_TITULO
 * @description Lista de identificadores de procedimientos para los cuales el título del modal de modificar facturador es aplicable.
 *
 * @type {number[]}
 */
export const MODIFICAR_FACTURADOR_MODAL_TITULO = [260603, 260604];
