  ...
  implements OnDestroy, OnInit, OnChanges
{
 ...
 /**
  ...
  /**
   * Lista temporal de códigos postales utilizada para almacenar los datos
   * de códigos postales obtenidos dinámicamente durante la edición o selección.
   * @property {Catalogo[]} codigosPostalesTempDatos
   */
    ...
    if (SELECTEDDATA.entidadFederativa || SELECTEDDATA.entidadFederativaObj) {
      ...
      if (ESTADOCLAVE) {
        ...
        if (MUNICIPIOCLAVE) {
          ...
          this.codigosPostalesDatos = AgregarFabricanteComponent.normalizarCodigoPostal(
    ...
    if (!this.codigosPostalesDatos.length) {
      this.datosSolicitudService
        ...
        .subscribe((data) => {
          ...
          this.codigosPostalesDatos = AgregarFabricanteComponent.normalizarCodigoPostal(DATOS);
        });
    }
