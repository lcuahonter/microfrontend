 ...
 * @type {number[]}
 */
export const OCULTAR_PROVEEDOR = [260102, 260101,260103,260104];
 ...
 * @type {number[]}
 */
export const OCULTAR_FACTURADOR = [260102, 260101,260103,260104];
...
export const PROCEDIMIENTOS_NO_PARA_ELEMENTO_RFC_DEL_SANITARIO = [
 260103,260102,260101,260104, 260704
];
 ...
 * }
 */
export const PROCEDIMIENTOS_NO_PARA_ELEMENTO_REGIMEN_Y_ADUNADEENTRADAS:number[] = [ 260704
 ...
 * }
 */
export const REPRESENTANTE_LEGAL_EN_INIT = [260101,260103,260102];
