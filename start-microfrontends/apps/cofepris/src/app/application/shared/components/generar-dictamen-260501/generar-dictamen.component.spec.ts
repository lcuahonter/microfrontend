...
import { GenerarDictamen260514Component } from './generar-dictamen.component';
import { FormBuilder, ReactiveFormsModule } from '@angular/forms';
import { ValidacionesFormularioService } from "@libs/shared/data-access-user/src";
import { By } from '@angular/platform-browser';

describe('GenerarDictamenComponent', () => {
    let component: GenerarDictamen260514Component;
    let fixture: ComponentFixture<GenerarDictamen260514Component>;
    let validacionesService: ValidacionesFormularioService;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [GenerarDictamen260514Component, ReactiveFormsModule],
            providers: [
                FormBuilder,
                {
        ...
        fixture = TestBed.createComponent(GenerarDictamen260514Component);
    ...
    it('debe validar que mensajeDictamen no acepte solo espacios', () => {
        ...
        control?.setValue('    ');
        expect(GenerarDictamen260514Component.noSoloEspacios(control!)).toEqual({ soloEspacios: true });
        control?.setValue('Texto válido');
        expect(GenerarDictamen260514Component.noSoloEspacios(control!)).toBeNull();
    });
    ...
    it('debe actualizar el campo antecedentesReadonly si cambia la conformidad', () => {
        ...
        (component as any).conformidad = 'Nuevo valor de conformidad';
