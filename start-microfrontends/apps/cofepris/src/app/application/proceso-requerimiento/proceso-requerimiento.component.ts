...
import { CodigoRespuesta, ProcesoSolicitud } from '../core/enum/cofepris-core-enum';
...
*/
  ...
  */
  ...
  constructor(
    ...
    //   folioTramite: '0402600200320254001000097',
    //   idSolicitudSeleccionada: '',
    //   id_solicitud: '202966067',
    //   nombre_pagina: '',
    //   parameter: 'AtenderRequerimiento',
    //   procedureId: '260203',
    //   readonly: true,
    //   tipoDeTramite:
    ...
    this.idSolicitud = Number(this.guardarDatos.id_solicitud);
  ...
  iniciarAtenderRequerimiento(): void {
    ...
    this.atenderRequerimientoService
      .getIniciarAtenderRequerimiento(this.tramite, NUMFOLIO)
      .subscribe({
        next: (resp) => {
            this.iniciarAtenderRequerimientoData =
            resp.datos ?? ({} as IniciarAtenderRequerimientoResponse);
          if (this.iniciarAtenderRequerimientoData.fecha_generacion) {
          this.iniciarAtenderRequerimientoData.fecha_generacion =
          this.iniciarAtenderRequerimientoData.fecha_generacion.replace(/-/g, '/');
    }
      },
        error: (err) => {
