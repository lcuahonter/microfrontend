...
/* Este archivo se utiliza para configurar Webpack para la aplicación maritimos en una configuración de federación de módulos */
...
module.exports = {
  ...
  // END DISABLE ngDevMode as it is not needed in a remoteEntry
    new ModuleFederationPlugin({
      ...
      exposes: {
        './Module': 'apps/maritimos/src/app/application/app.module.ts',
