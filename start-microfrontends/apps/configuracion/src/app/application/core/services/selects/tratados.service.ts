...
export class tratadosSelectService {
    /**
     ...
     */
    public obtenerListaTratados(): Observable<ListaSelect[]> {
        return this.http.get<ListaSelect[]>('/assets/json/configuracion/tratados/tratados.json')
    }
    /**
    ...
    public obtenerMedidas():Observable<ListaSelect[]>{
        return this.http.get<ListaSelect[]>('/assets/json/configuracion/config/cupos/mundial/medidas.json')
    }
}