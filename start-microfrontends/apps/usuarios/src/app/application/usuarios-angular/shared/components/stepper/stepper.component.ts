...
@Component({
  ...
  styles: [`
    ...
    .vuc-stepper__progress { height: 4px; background: #dee2e6; border-radius: 2px; margin-bottom: 24px; }
    ...
    .vuc-stepper__step-circle {
      width: 36px; height: 36px; border-radius: 50%; border: 2px solid #adb5bd;
      display: flex; align-items: center; justify-content: center;
      font-weight: 600; color: #adb5bd; background: white; transition: all 0.3s;
    }
    ...
    .vuc-stepper__step-label { font-size: 12px; color: #6c757d; text-align: center; max-width: 80px; }
    .vuc-stepper__step.active .vuc-stepper__step-label { color: #006847; font-weight: 600; }
    .vuc-stepper__connector { flex: 1; height: 2px; background: #dee2e6; margin: 0 8px; margin-bottom: 24px; }
