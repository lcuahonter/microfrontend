...
const ROUTES: Routes = [
  { path: '', pathMatch: 'full', redirectTo: 'manifestacion-valor' },

  // Manifiestos manifestacionvalor (9 rutas)
  {
    path: 'manifestacion-valor',
    loadComponent: () =>
      import('./pages/manifestacion-valor/manifestacion-valor.component').then(
        (m) => m.ManifestacionValorComponent
      ),
  },
  {
    path: 'bitacoraprueba',
