...
/* Este archivo se utiliza para configurar Webpack para la aplicación manifestacionvalor en una configuración de federación de módulos */
...
module.exports = {
  ...
  // END DISABLE ngDevMode as it is not needed in a remoteEntry
    new ModuleFederationPlugin({
      ...
      exposes: {
        './Module': 'apps/manifestacionvalor/src/app/application/app.module.ts',
