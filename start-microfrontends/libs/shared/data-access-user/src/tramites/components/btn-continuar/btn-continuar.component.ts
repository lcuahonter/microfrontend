 ...
 */
  ...
  /**
   * @property anteriorEvento
   * @description Evento emitido al hacer clic en el botón Anterior.
   * @type {EventEmitter<AccionBoton>}
   */
  @Output() anteriorEvento = new EventEmitter<AccionBoton>();
  ...
  /**
   * @property btnTextVisible
   * @description Indica si el texto del botón debe ser visible.
   * @type {boolean}
   * @default true
   */
  @Input() btnTextVisible: boolean = true;
  ...
  anterior(): void {
    ...
    this.anteriorEvento.emit(DATOS_ANTERIOR);
  }
