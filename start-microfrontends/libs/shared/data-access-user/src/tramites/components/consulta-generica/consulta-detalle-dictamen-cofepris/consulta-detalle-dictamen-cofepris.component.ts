...
@Component({
  selector: 'lib-detalle-dictamen-cofepris',
  standalone: true,
...
export class ConsultaDetalleDictamenCofeprisComponent implements OnInit, OnChanges, OnDestroy {
    ...
    ([plazoResp, motivoRechazoResp, motivoParcialResp, autorizadorResp]) => {
      ...
      if (this.dictamenDetalle !== null) {
        ...
        this.detalleForm.patchValue({
          ...
          fechaFinVigencia: ConsultaDetalleDictamenCofeprisComponent.formatearFecha(SOLICITUDDATA.fecha_fin_vigencia)
        });
