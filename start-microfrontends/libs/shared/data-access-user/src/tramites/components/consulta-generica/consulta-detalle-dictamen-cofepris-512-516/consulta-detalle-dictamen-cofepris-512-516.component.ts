...
@Component({
  selector: 'lib-detalle-dictamen-cofepris-512-516',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule,CatalogoSelectComponent],
  templateUrl: './consulta-detalle-dictamen-cofepris-512-516.component.html',
  styleUrl: './consulta-detalle-dictamen-cofepris-512-516.component.scss',
})
export class ConsultaDetalleDictamenCofepris512516Component implements OnInit, OnChanges, OnDestroy {
