...
export interface MercanciasDatos {
  /** Identificador único del registro de mercancía */
  idMercancia?: number,
...
export interface Fabricante {
  ...
  datosPersonalesNombre:string|null,
  datosPersonalesPrimerApellido:string|null,
  datosPersonalesSegundoApellido:string|null,
  tipoPersona:string|null,
  tercerosNacionalidad:string|null,
